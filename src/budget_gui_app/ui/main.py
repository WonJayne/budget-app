...
- Rules can be global with Source = **Any** or source-scoped to an observed import source. Inflow rules classify positive transactions only; outflow rules classify negative transactions only; transfer rules can classify either sign. Manual assignments and transfer groups/notes survive rule changes.
